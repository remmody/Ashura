...
struct MangaDetailsHeaderView: View {
    @Binding var source: AshuraRunner.Source?

    @Binding var manga: AshuraRunner.Manga
    @Binding var chapters: [AshuraRunner.Chapter]
    @Binding var nextChapter: AshuraRunner.Chapter?
    ...
    init(
        source: Binding<AshuraRunner.Source?>,
        manga: Binding<AshuraRunner.Manga>,
        chapters: Binding<[AshuraRunner.Chapter]>,
        nextChapter: Binding<AshuraRunner.Chapter?>,
...
#Preview {
    ...
    MangaDetailsHeaderView(
        source: Binding.constant(AshuraRunner.Source.demo()),
        manga: Binding.constant(AshuraRunner.Manga(
            sourceKey: "",
            key: "",
            title: "Manga",
            authors: ["Author"],
