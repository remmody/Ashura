...
struct MangaView: View {
    ...
    @State private var openChapter: AshuraRunner.Chapter?
...
extension MangaView {
    ...
    @ViewBuilder
    func viewForChapter(_ chapter: AshuraRunner.Chapter, index: Int, secondSection: Bool = false) -> some View {
        ...
        Section {
            ...
            if !last && !secondSection {
                Menu(NSLocalizedString("MARK_PREVIOUS")) {
                    Button {
                        let chapters = [AshuraRunner.Chapter](viewModel.chapters[
...
extension MangaView {
    func showShareSheet(chapter: AshuraRunner.Chapter) {
