...
struct MigrateSingleSearchView: View {
    ...
    let selectedSeries: AshuraRunner.Manga

    var resultSeries: Binding<AshuraRunner.Manga?>?

    struct SearchResult: Identifiable, Equatable {
        let source: AshuraRunner.Source
        let result: AshuraRunner.MangaPageResult
    ...
    @State private var targetSeries: AshuraRunner.Manga?
    ...
    init(
        ...
        resultSeries: Binding<AshuraRunner.Manga?>? = nil
    ) {
...
extension MigrateSingleSearchView {
    func search(delay: Bool = false) {
        ...
        searchTask = Task {
            ...
            await withTaskGroup(of: (AshuraRunner.Source, AshuraRunner.MangaPageResult?).self) { group in
