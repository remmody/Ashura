...
struct MigrateResultsView: View {
    let targetSources: [AshuraRunner.Source]
    @State private var selectedSeries: [AshuraRunner.Manga]
    ...
    @State private var migratedManga: [MangaIdentifier: AshuraRunner.Manga?] = [:]
    @State private var newChapters: [MangaIdentifier: [AshuraRunner.Chapter]] = [:]
    ...
    init(
        targetSources: [AshuraRunner.Source],
        selectedSeries: [AshuraRunner.Manga],
...
extension MigrateResultsView {
    func remove(manga: AshuraRunner.Manga) {
    ...
    func migratedMangaBinding(for key: MangaIdentifier) -> Binding<AshuraRunner.Manga?> {
        .init(
...
extension MigrateResultsView {
    func startMatching() async {
        ...
        await withTaskGroup(of: (MangaIdentifier, AshuraRunner.Manga?).self) { group in
...
extension MigrateResultsView {
    struct MangaToMangaView: View {
        ...
        let toSource: String?
        let fromManga: AshuraRunner.Manga
        @Binding var toManga: AshuraRunner.Manga?
