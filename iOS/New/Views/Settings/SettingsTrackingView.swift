...
struct SettingsTrackingView: View {
    ...
    @State private var komgaSources: [AshuraRunner.Source] = []
    @State private var kavitaSources: [AshuraRunner.Source] = []
    @State private var suwayomiSources: [AshuraRunner.Source] = []
    ...
    var body: some View {
        List {
            ...
            if !komgaSources.isEmpty || !kavitaSources.isEmpty || !suwayomiSources.isEmpty {
                Section {
                    let items: [(tracker: Tracker, sources: [AshuraRunner.Source])] = [
    ...
    func enhancedTrackerPage(name: String, sources: [AshuraRunner.Source]) -> some View {
        List {
            Section {
...
extension SettingsTrackingView {
    func loadEnhancedTrackerSources() {
        var komgaSources: [AshuraRunner.Source] = []
        var kavitaSources: [AshuraRunner.Source] = []
        var suwayomiSources: [AshuraRunner.Source] = []
