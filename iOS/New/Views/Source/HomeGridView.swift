...
struct HomeGridView: View {
    ...
    let entries: [AshuraRunner.Manga]
    @Binding var bookmarkedItems: Set<String>
    var loadMore: (() async -> Void)?
    var onSelect: ((AshuraRunner.Manga) -> Void)?
    ...
    private func mangaGridItem(entry: AshuraRunner.Manga) -> some View {
