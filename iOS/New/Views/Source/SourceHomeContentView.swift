...
struct SourceHomeContentView: View {
    ...
    @Binding var listings: [AshuraRunner.Listing]
    ...
    @State private var entries: [AshuraRunner.Manga] = []
    ...
    private var currentListing: AshuraRunner.Listing? {
        listing(for: listingSelection)
    }

    private func listing(for selection: Int) -> AshuraRunner.Listing? {
    ...
    init(
        ...
        listings: Binding<[AshuraRunner.Listing]>,
