...
struct SelectFilterView: View {
    let filter: AshuraRunner.Filter

    @Binding var enabledFilters: [FilterValue]

    private let selectFilter: AshuraRunner.SelectFilter

    @State private var showingSheet = false
    @State private var selectedOption: String

    init(filter: AshuraRunner.Filter, enabledFilters: Binding<[FilterValue]>) {
        self.filter = filter
...
struct SelectFilterGroupView: View {
    ...
    init(filter: AshuraRunner.Filter, searchText: String? = nil, selectedOption: Binding<String>) {
        self.filter = filter
