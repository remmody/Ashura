...
class NewSourceViewController: UIViewController {
    ...
    private var listings: [AshuraRunner.Listing] = [] {
        didSet {
    ...
    private var filters: [AshuraRunner.Filter]? {
        didSet {
            updateHostingControllers()
        }
    }
    ...
    private var listingsBinding: Binding<[AshuraRunner.Listing]> {
        .init(
    ...
    private var filtersBinding: Binding<[AshuraRunner.Filter]?> {
        .init(
