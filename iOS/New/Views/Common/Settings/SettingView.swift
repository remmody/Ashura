...
/// View for a given AshuraRunner Setting.
struct SettingView: View {
    ...
    init(
        ...
        // used because the language setting comes from the AshuraRunner package, where it can't be localized
        var setting = setting
...
struct SettingPageDestination: View {
    var source: AshuraRunner.Source?
    let setting: Setting
    var namespace: String?
    var onChange: ((String) -> Void)?
