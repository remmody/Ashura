...
class MangaCollectionViewController: BaseCollectionViewController {
    ...
    var entries: [AshuraRunner.Manga] = []
    ...
    override func observe() {
        ...
        addObserver(forName: .addToLibrary) { [weak self] notification in
            guard
                let self,
                let manga = notification.object as? AshuraRunner.Manga,
...
extension MangaCollectionViewController {
    ...
    typealias GridCellRegistration = UICollectionView.CellRegistration<MangaGridCell, AshuraRunner.Manga>
    typealias ListCellRegistration = UICollectionView.CellRegistration<MangaListCell, AshuraRunner.Manga>
    ...
    func makeDataSource() -> UICollectionViewDiffableDataSource<Section, AshuraRunner.Manga> {
        if usesListLayout {
    ...
    func updateDataSource() {
        var snapshot = NSDiffableDataSourceSnapshot<Section, AshuraRunner.Manga>()
