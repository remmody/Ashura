    ...
    func updateFilters(_ filters: [FilterValue]) {
        ...
        if !searchQuery.isEmpty {
            ...
            searchTask = Task {
                ...
                let filteredSources: [AshuraRunner.Source] = filteredSources()
...
extension SearchContentView.ViewModel {
    ...
    private func filteredSources() -> [AshuraRunner.Source] {
    ...
    private func appendFetchedData(query: String, sources: [AshuraRunner.Source]) async {
