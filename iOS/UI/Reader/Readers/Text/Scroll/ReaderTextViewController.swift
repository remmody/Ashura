...
class ReaderTextViewController: BaseViewController {
    ...
    private func createInlineTransitionView(
        finishedChapter: AshuraRunner.Chapter,
        nextChapter: AshuraRunner.Chapter?
    ) -> ReaderInfoPageView {
...
extension ReaderTextViewController {
    ...
    func loadInitialChapter(_ chapter: AshuraRunner.Chapter, restorePosition: Bool = true) async {
...
extension ReaderTextViewController: ReaderReaderDelegate {
    ...
    func setChapter(_ chapter: AshuraRunner.Chapter, startPage: Int) {
