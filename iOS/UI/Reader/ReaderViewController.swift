...
class ReaderViewController: BaseObservingViewController {
    ...
    private var chapterList: [AshuraRunner.Chapter]
    private var chaptersToMark: [AshuraRunner.Chapter] = []
    private var chaptersToRemoveDownload: [AshuraRunner.Chapter] = [] {
        didSet {
...
//                    recognizer.isEnabled = true
    ...
    func updateReadPosition(
        currentPage: Int? = nil,
        totalPages: Int? = nil,
        chapter: AshuraRunner.Chapter? = nil
    ) async {
    ...
    private func saveReadingSession(chapter: AshuraRunner.Chapter? = nil) async {
...
extension ReaderViewController: ReaderHoldingDelegate {
    ...
    private func areDuplicates(_ a: AshuraRunner.Chapter, _ b: AshuraRunner.Chapter) -> Bool {
        a.chapterNumber == b.chapterNumber
            && a.volumeNumber == b.volumeNumber
            && (!(a.chapterNumber == nil && a.volumeNumber == nil) || a.title == b.title)
    }

    private func isValidScanlatorMatch(for next: AshuraRunner.Chapter, current: Set<String>) -> Bool {
    ...
    private func findBestChapterMatch(from index: Int, step: Int) -> AshuraRunner.Chapter {
    ...
    func getNextChapter() -> AshuraRunner.Chapter? {
        ...
        index -= 1
        var nextChapterInList: AshuraRunner.Chapter?
