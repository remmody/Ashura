...
extension ComicInfo {
    static func load(manga: AshuraRunner.Manga, chapter: AshuraRunner.Chapter) -> ComicInfo {
    ...
    func toManga() -> AshuraRunner.Manga? {
        guard
        ...
        let basicManga = AshuraRunner.Manga(sourceKey: sourceKey, key: key, title: series ?? "")
        return copy(into: basicManga)
    }

    func toChapter() -> AshuraRunner.Chapter? {
        guard
            let extraData = extraData(),
        ...
        let basicChapter = AshuraRunner.Chapter(key: key)
        return copy(into: basicChapter)
    }

    func copy(into manga: AshuraRunner.Manga) -> AshuraRunner.Manga {
    ...
    func copy(into chapter: AshuraRunner.Chapter) -> AshuraRunner.Chapter {
