...
enum PublishingStatus: Int, Codable {
    ...
    func toNew() -> AshuraRunner.PublishingStatus {
        switch self {
...
enum MangaContentRating: Int, Codable, CaseIterable {
    ...
    func toNew() -> AshuraRunner.ContentRating {
        switch self {
            case .safe: .safe
...
enum MangaViewer: Int, Codable {
    ...
    func toNew() -> AshuraRunner.Viewer {
        switch self {
...
struct MangaPageResult {
    ...
    func toNew() -> AshuraRunner.MangaPageResult {
        AshuraRunner.MangaPageResult(entries: manga.map { $0.toNew() }, hasNextPage: hasNextPage)
    }
}
