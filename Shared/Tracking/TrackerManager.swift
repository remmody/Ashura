...
actor TrackerManager {
    ...
    func setProgress(sourceKey: String, mangaKey: String, chapter: AshuraRunner.Chapter, progress: ChapterReadProgress) async {
        await setProgress(sourceKey: sourceKey, mangaKey: mangaKey, chapters: [chapter], progress: progress)
    }

    func setProgress(sourceKey: String, mangaKey: String, chapters: [AshuraRunner.Chapter], progress: ChapterReadProgress) async {
    ...
    func register(tracker: Tracker, manga: AshuraRunner.Manga, item: TrackSearchItem) async {
    ...
    func syncProgressFromTracker(
        ...
        chapters: [AshuraRunner.Chapter]? = nil
    ) async {
    ...
    func bindEnhancedTrackers(manga: AshuraRunner.Manga) async {
...
extension TrackerManager {
    private func getChapters(manga: AshuraRunner.Manga) async -> [AshuraRunner.Chapter] {
    ...
    func getChaptersToSyncProgressFromTracker(
        ...
        var chaptersToMark: [AshuraRunner.Chapter] = []
