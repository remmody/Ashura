...
final class AniListTracker: OAuthTracker {
    ...
    // Ashura: AniList supports anime tracking (phase4 scaffolding, not yet wired up).
    ...
    func search(for manga: AshuraRunner.Manga, includeNsfw: Bool) async -> [TrackSearchItem] {
