...
struct PageInterceptorProcessor: ImageProcessing {
    ...
    func process(_ container: ImageContainer, context: ImageProcessingContext) throws -> ImageContainer {
        ...
        let output: AshuraRunner.PlatformImage? = try BlockingThrowingTask {
    ...
    func processAsync(_ container: ImageContainer, context: ImageProcessingContext) async throws -> AshuraRunner.PlatformImage? {
